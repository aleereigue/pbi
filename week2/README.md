...
:white_check_mark: If you haven't completed the tasks from weeks 0 and 1 please do so this week.

On Tuesday, I will take you through a tour of data sources that are widely used in biomedical and clinical data science, run the code from last week, and introduce bulk FTP and API based querying & download.
